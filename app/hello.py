...
def hello():
    if request.method=='POST':
        ...
        print(result)
        if result=='N':
            return render_template('data.html',result='Negitive',sug='You\'r Helath Is Fine')
        else:
            return render_template('data.html',result='Positive',sug='Please Consult A doctor Earlier')
    else:
